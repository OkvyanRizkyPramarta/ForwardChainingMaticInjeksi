						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									<div class="">
                                        <h3>Buat Data Baru Berita / Informasi</h3>
                        ...
                        @csrf
                            <div class="basic-tb-hd">
                                ...
                                <div class="form-group">
                                    <div class="nk-int-st">
                                        <input type="text" name="title" class="form-control" placeholder="Tanda Tanda Motor Matic Injeksi Bermasalah">
                                    </div>
                                </div>
                            </div>
                            <div class="basic-tb-hd">
                                ...
                                <div class="form-group">
                                    <div class="nk-int-st">
                                        <input type="text" name="writer" class="form-control" placeholder="Admin">
                                    </div>
                                </div>
                            </div>
                            <div class="basic-tb-hd">
